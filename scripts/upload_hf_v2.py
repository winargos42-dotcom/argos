#!/usr/bin/env python3
"""Upload ARGOS dataset to HF Hub."""
import os
os.environ["HF_TOKEN"] = "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"

from huggingface_hub import HfApi, create_repo

REPO_ID = "AvaSiG/argos-quantum-train-v2"
...
# Создаём репозиторий
try:
    create_repo(REPO_ID, repo_type="dataset", token=os.environ["HF_TOKEN"], exist_ok=True, private=False)
...
# 🧠 ARGOS Quantum Training Dataset v2
...
ds = load_dataset("AvaSiG/argos-quantum-train-v2", split="train")
```
