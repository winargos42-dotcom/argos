...
source_path: claude-code-templates/docs/blog/README.md
source_abs: F:\debug\argoss\claude-code-templates\docs\blog\README.md
source_ext: .md
...
- Source: `claude-code-templates/docs/blog/README.md`
- Extract: `text`
