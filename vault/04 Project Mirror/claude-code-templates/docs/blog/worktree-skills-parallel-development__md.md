...
source_path: claude-code-templates/docs/blog/worktree-skills-parallel-development.md
source_abs: F:\debug\argoss\claude-code-templates\docs\blog\worktree-skills-parallel-development.md
source_ext: .md
...
- Source: `claude-code-templates/docs/blog/worktree-skills-parallel-development.md`
- Extract: `text`
