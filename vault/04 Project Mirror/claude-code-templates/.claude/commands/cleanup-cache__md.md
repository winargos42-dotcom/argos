...
source_path: claude-code-templates/.claude/commands/cleanup-cache.md
source_abs: F:\debug\argoss\claude-code-templates\.claude\commands\cleanup-cache.md
source_ext: .md
...
- Source: `claude-code-templates/.claude/commands/cleanup-cache.md`
- Extract: `text`
