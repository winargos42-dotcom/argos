...
source_path: claude-code-templates/cli-tool/components/skills/document-processing/pptx/html2pptx.md
source_abs: F:\debug\argoss\claude-code-templates\cli-tool\components\skills\document-processing\pptx\html2pptx.md
source_ext: .md
...
- Source: `claude-code-templates/cli-tool/components/skills/document-processing/pptx/html2pptx.md`
- Extract: `text`
