...
source_path: claude-code-templates/cli-tool/components/skills/document-processing/pptx/ooxml.md
source_abs: F:\debug\argoss\claude-code-templates\cli-tool\components\skills\document-processing\pptx\ooxml.md
source_ext: .md
...
- Source: `claude-code-templates/cli-tool/components/skills/document-processing/pptx/ooxml.md`
- Extract: `text`
