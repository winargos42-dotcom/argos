...
source_path: claude-code-templates/cli-tool/components/skills/productivity/planning-with-files/examples.md
source_abs: F:\debug\argoss\claude-code-templates\cli-tool\components\skills\productivity\planning-with-files\examples.md
source_ext: .md
...
- Source: `claude-code-templates/cli-tool/components/skills/productivity/planning-with-files/examples.md`
- Extract: `text`
