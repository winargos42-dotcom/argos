...
source_path: claude-code-templates/cli-tool/components/skills/scientific/pptx-posters/references/poster_design_principles.md
source_abs: F:\debug\argoss\claude-code-templates\cli-tool\components\skills\scientific\pptx-posters\references\poster_design_principles.md
source_ext: .md
...
- Source: `claude-code-templates/cli-tool/components/skills/scientific/pptx-posters/references/poster_design_principles.md`
- Extract: `text`
