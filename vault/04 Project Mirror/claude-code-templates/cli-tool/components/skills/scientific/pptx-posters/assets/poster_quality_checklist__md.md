...
source_path: claude-code-templates/cli-tool/components/skills/scientific/pptx-posters/assets/poster_quality_checklist.md
source_abs: F:\debug\argoss\claude-code-templates\cli-tool\components\skills\scientific\pptx-posters\assets\poster_quality_checklist.md
source_ext: .md
...
- Source: `claude-code-templates/cli-tool/components/skills/scientific/pptx-posters/assets/poster_quality_checklist.md`
- Extract: `text`
