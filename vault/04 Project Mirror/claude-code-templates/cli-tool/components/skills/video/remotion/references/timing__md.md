...
source_path: claude-code-templates/cli-tool/components/skills/video/remotion/references/timing.md
source_abs: F:\debug\argoss\claude-code-templates\cli-tool\components\skills\video\remotion\references\timing.md
source_ext: .md
...
- Source: `claude-code-templates/cli-tool/components/skills/video/remotion/references/timing.md`
- Extract: `text`
