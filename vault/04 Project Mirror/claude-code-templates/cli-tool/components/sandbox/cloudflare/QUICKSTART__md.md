...
source_path: claude-code-templates/cli-tool/components/sandbox/cloudflare/QUICKSTART.md
source_abs: F:\debug\argoss\claude-code-templates\cli-tool\components\sandbox\cloudflare\QUICKSTART.md
source_ext: .md
...
- Source: `claude-code-templates/cli-tool/components/sandbox/cloudflare/QUICKSTART.md`
- Extract: `text`
