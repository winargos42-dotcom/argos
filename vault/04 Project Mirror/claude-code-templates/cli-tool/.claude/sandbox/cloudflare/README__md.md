...
source_path: claude-code-templates/cli-tool/.claude/sandbox/cloudflare/README.md
source_abs: F:\debug\argoss\claude-code-templates\cli-tool\.claude\sandbox\cloudflare\README.md
source_ext: .md
...
- Source: `claude-code-templates/cli-tool/.claude/sandbox/cloudflare/README.md`
- Extract: `text`
