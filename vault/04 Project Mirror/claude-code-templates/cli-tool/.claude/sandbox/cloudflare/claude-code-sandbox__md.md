...
source_path: claude-code-templates/cli-tool/.claude/sandbox/cloudflare/claude-code-sandbox.md
source_abs: F:\debug\argoss\claude-code-templates\cli-tool\.claude\sandbox\cloudflare\claude-code-sandbox.md
source_ext: .md
...
- Source: `claude-code-templates/cli-tool/.claude/sandbox/cloudflare/claude-code-sandbox.md`
- Extract: `text`
