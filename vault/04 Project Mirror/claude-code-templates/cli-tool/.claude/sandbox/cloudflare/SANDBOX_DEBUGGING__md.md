...
source_path: claude-code-templates/cli-tool/.claude/sandbox/cloudflare/SANDBOX_DEBUGGING.md
source_abs: F:\debug\argoss\claude-code-templates\cli-tool\.claude\sandbox\cloudflare\SANDBOX_DEBUGGING.md
source_ext: .md
...
- Source: `claude-code-templates/cli-tool/.claude/sandbox/cloudflare/SANDBOX_DEBUGGING.md`
- Extract: `text`
