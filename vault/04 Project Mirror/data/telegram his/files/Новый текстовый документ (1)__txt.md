...
source_path: data/telegram his/files/Новый текстовый документ (1).txt
source_abs: F:\debug\argoss\data\telegram his\files\Новый текстовый документ (1).txt
source_ext: .txt
...
- Source: `data/telegram his/files/Новый текстовый документ (1).txt`
- Extract: `text`
