...
source_path: data/telegram his/files/README (10).md
source_abs: F:\debug\argoss\data\telegram his\files\README (10).md
source_ext: .md
source_sha256: a5a965abe814bf35e8e05551837e90aee057ccedb7895824cd10da4279cf390f
text_sha256: a5a965abe814bf35e8e05551837e90aee057ccedb7895824cd10da4279cf390f
extract_mode: text
...
- Source: `data/telegram his/files/README (10).md`
- Extract: `text`
- SHA256: `a5a965abe814bf35e8e05551837e90aee057ccedb7895824cd10da4279cf390f`
...
git clone https://github.com/iliyaqdrwalqu/SiGtRiP.git && cd Argoss
...
1. Открой ноутбук: [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/iliyaqdrwalqu/SiGtRiP/blob/main/colab/ARGOS_Colab_Launch.ipynb)
...
| Шаг | Что делает |
|-----|------------|
| 1️⃣  Clone | `git clone https://github.com/iliyaqdrwalqu/SiGtRiP` |
...
```bash
# В ячейке Colab:
!bash <(curl -fsSL https://raw.githubusercontent.com/iliyaqdrwalqu/SiGtRiP/main/colab_start.sh)
```
