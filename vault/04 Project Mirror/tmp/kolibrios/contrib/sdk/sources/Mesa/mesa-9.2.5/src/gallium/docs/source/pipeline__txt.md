...
source_path: tmp/kolibrios/contrib/sdk/sources/Mesa/mesa-9.2.5/src/gallium/docs/source/pipeline.txt
source_abs: F:\debug\argoss\tmp\kolibrios\contrib\sdk\sources\Mesa\mesa-9.2.5\src\gallium\docs\source\pipeline.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/contrib/sdk/sources/Mesa/mesa-9.2.5/src/gallium/docs/source/pipeline.txt`
- Extract: `text`
