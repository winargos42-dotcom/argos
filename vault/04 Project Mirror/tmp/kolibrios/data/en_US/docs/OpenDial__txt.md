...
source_path: tmp/kolibrios/data/en_US/docs/OpenDial.txt
source_abs: F:\debug\argoss\tmp\kolibrios\data\en_US\docs\OpenDial.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/data/en_US/docs/OpenDial.txt`
- Extract: `text`
