...
source_path: tmp/kolibrios/data/en_US/docs/KFAR_Keys.txt
source_abs: F:\debug\argoss\tmp\kolibrios\data\en_US\docs\KFAR_Keys.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/data/en_US/docs/KFAR_Keys.txt`
- Extract: `text`
