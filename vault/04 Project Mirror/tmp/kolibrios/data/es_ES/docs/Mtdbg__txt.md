...
source_path: tmp/kolibrios/data/es_ES/docs/Mtdbg.txt
source_abs: F:\debug\argoss\tmp\kolibrios\data\es_ES\docs\Mtdbg.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/data/es_ES/docs/Mtdbg.txt`
- Extract: `text`
