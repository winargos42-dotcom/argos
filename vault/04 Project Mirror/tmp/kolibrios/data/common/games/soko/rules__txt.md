...
source_path: tmp/kolibrios/data/common/games/soko/rules.txt
source_abs: F:\debug\argoss\tmp\kolibrios\data\common\games\soko\rules.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/data/common/games/soko/rules.txt`
- Extract: `text`
