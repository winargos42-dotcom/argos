...
source_path: tmp/kolibrios/kernel/branches/kolibri_pe/docs/apm.txt
source_abs: F:\debug\argoss\tmp\kolibrios\kernel\branches\kolibri_pe\docs\apm.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/kernel/branches/kolibri_pe/docs/apm.txt`
- Extract: `text`
