...
source_path: tmp/kolibrios/kernel/branches/kolibri-ahci/docs/events_subsystem.ru.txt
source_abs: F:\debug\argoss\tmp\kolibrios\kernel\branches\kolibri-ahci\docs\events_subsystem.ru.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/kernel/branches/kolibri-ahci/docs/events_subsystem.ru.txt`
- Extract: `text`
