...
source_path: tmp/kolibrios/kernel/branches/kolibri-ahci/docs/stack.txt
source_abs: F:\debug\argoss\tmp\kolibrios\kernel\branches\kolibri-ahci\docs\stack.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/kernel/branches/kolibri-ahci/docs/stack.txt`
- Extract: `text`
