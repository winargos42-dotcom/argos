...
source_path: tmp/kolibrios/kernel/branches/kolibri-lldw/docs/events_subsystem.txt
source_abs: F:\debug\argoss\tmp\kolibrios\kernel\branches\kolibri-lldw\docs\events_subsystem.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/kernel/branches/kolibri-lldw/docs/events_subsystem.txt`
- Extract: `text`
