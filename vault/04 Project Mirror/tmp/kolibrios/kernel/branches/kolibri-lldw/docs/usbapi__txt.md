...
source_path: tmp/kolibrios/kernel/branches/kolibri-lldw/docs/usbapi.txt
source_abs: F:\debug\argoss\tmp\kolibrios\kernel\branches\kolibri-lldw\docs\usbapi.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/kernel/branches/kolibri-lldw/docs/usbapi.txt`
- Extract: `text`
