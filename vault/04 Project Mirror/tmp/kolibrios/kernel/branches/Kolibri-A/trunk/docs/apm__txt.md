...
source_path: tmp/kolibrios/kernel/branches/Kolibri-A/trunk/docs/apm.txt
source_abs: F:\debug\argoss\tmp\kolibrios\kernel\branches\Kolibri-A\trunk\docs\apm.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/kernel/branches/Kolibri-A/trunk/docs/apm.txt`
- Extract: `text`
