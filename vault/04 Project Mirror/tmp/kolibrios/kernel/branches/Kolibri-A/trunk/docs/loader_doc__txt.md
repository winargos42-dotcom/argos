...
source_path: tmp/kolibrios/kernel/branches/Kolibri-A/trunk/docs/loader_doc.txt
source_abs: F:\debug\argoss\tmp\kolibrios\kernel\branches\Kolibri-A\trunk\docs\loader_doc.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/kernel/branches/Kolibri-A/trunk/docs/loader_doc.txt`
- Extract: `text`
