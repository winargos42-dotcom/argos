...
source_path: tmp/kolibrios/kernel/branches/Kolibri-acpi/docs/usbapi.txt
source_abs: F:\debug\argoss\tmp\kolibrios\kernel\branches\Kolibri-acpi\docs\usbapi.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/kernel/branches/Kolibri-acpi/docs/usbapi.txt`
- Extract: `text`
