...
source_path: tmp/kolibrios/kernel/trunk/docs/drivers_api.txt
source_abs: F:\debug\argoss\tmp\kolibrios\kernel\trunk\docs\drivers_api.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/kernel/trunk/docs/drivers_api.txt`
- Extract: `text`
