...
source_path: tmp/kolibrios/kernel/trunk/docs/usbapi.txt
source_abs: F:\debug\argoss\tmp\kolibrios\kernel\trunk\docs\usbapi.txt
source_ext: .txt
...
- Source: `tmp/kolibrios/kernel/trunk/docs/usbapi.txt`
- Extract: `text`
