...
source_path: docs/references/Новый документ(3).docx
source_abs: F:\debug\argoss\docs\references\Новый документ(3).docx
source_ext: .docx
...
- Source: `docs/references/Новый документ(3).docx`
- Extract: `docx`
