...
source_path: docs/references/Новый документ(4).docx
source_abs: F:\debug\argoss\docs\references\Новый документ(4).docx
source_ext: .docx
...
# Новый документ(4).docx

- Source: `docs/references/Новый документ(4).docx`
- Extract: `docx`
