...
source_path: claude/claude-code-system-prompt.md
source_abs: C:\Users\AvA\OneDrive\ObsidianShared\SharedMemory\claude\claude-code-system-prompt.md
mirrored_at: 2026-05-10 14:00:58
---

# SharedMemory: claude/claude-code-system-prompt.md

- Source: `C:\Users\AvA\OneDrive\ObsidianShared\SharedMemory\claude\claude-code-system-prompt.md`
- Category: [[Claude Hub]]

## Content

# Claude Code System Prompt
*Сохранено: 2026-05-09*
...
## Environment
- Primary working directory: /home/ava
- Platform: linux
- Shell: bash
- OS Version: Linux 7.0.3-arch1-2
- Model: claude-sonnet-4-6
- Knowledge cutoff: August 2025
- Most recent Claude model family: Claude 4.X
  - Opus 4.7: `claude-opus-4-7`
  - Sonnet 4.6: `claude-sonnet-4-6`
  - Haiku 4.5: `claude-haiku-4-5-20251001`

## Language
Always respond in russian. Use russian for all explanations, comments, and communications with the user. Technical terms and code identifiers should remain in their original form.
Maintain full orthographic correctness for russian, including all required diacritical marks, accents, and special characters.
...
- SharedMemory source: `claude/claude-code-system-prompt.md`
