...
ENTITIES: Dict[str, EntityConfig] = {
    ...
    "gemini": EntityConfig(
        name="gemini",
        display_name="Gemini Flash (GCP Proxy)",
        entity_type="ai_provider",
        status="active",
        ...
        description="Google Gemini Flash через GCP proxy (обход гео-блока РФ)",
    ),
    ...
    "ollama_vision": EntityConfig(
        ...
        entity_type="vision",
        status="standby",
        api_endpoint="http://192.168.1.53:11434",
        model="moondream",
        context_window=0,
        ...
        description="Local vision analysis via Ollama moondream on PC GPU",
    ),
    ...
    "openai": EntityConfig(
        name="openai",
        display_name="OpenAI GPT Agent (GCP Proxy)",
        entity_type="ai_provider",
        status="active",
    ...
    "argos": EntityConfig(
        ...
        entity_type="ai_provider",
        status="active",
        api_endpoint="http://192.168.1.53:5001",
        model="argos-brain",
